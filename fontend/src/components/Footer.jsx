                ...
                <div className='w-full max-w-7xl mx-auto'>
                    ...
                    <div className="flex flex-wrap justify-between gap-y-12 lg:gap-x-8">
                        ...
                        <div className="w-full md:w-[45%] lg:w-[35%] flex flex-col items-center md:items-start text-center md:text-left">
                            <a href="/">
                                <img src="public/PHG_logo2-while.png" alt="logo" width="157" height="40" />
                            </a>
                            ...
                            <p className='text-sm text-white/60 mt-6 max-w-sm leading-relaxed'>
                               PHG exists to elevate living and hospitality experiences through its spaces, services, and people.
                            </p>
                        </div>
            
                        <div className="w-full md:w-[45%] lg:w-[15%] flex flex-col items-center md:items-start text-center md:text-left">
                            <h3 className='text-sm text-white/60 font-medium'>Important Links</h3>
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                        <p className='text-xs text-white/60'>© 2026 PHGGroup. All rights reserved.</p>
